    ...
    return (
        <header className="flex justify-between p-lg">
            <div className="flex items-center">
                <button className="flex items-center justify-center bg-l-traslucid-5 dark:bg-traslucid-5 p-sm rounded-full mr-2 h-9 aspect-square hover:bg-traslucid-5 dark:hover:bg-l-traslucid-5 transition-all duration-500"
                    onClick={() => onNavigate(-1)}>
                    <svg role="img" viewBox="0 0 16 16" className="h-3 fill-white">
                        <path d="M11.03.47a.75.75 0 0 1 0 1.06L4.56 8l6.47 6.47a.75.75 0 1 1-1.06 1.06L2.44 8 9.97.47a.75.75 0 0 1 1.06 0z"></path>
                    </svg>
                </button>
                <button className="flex items-center justify-center bg-l-traslucid-5 dark:bg-traslucid-5 p-sm rounded-full h-9 aspect-square hover:bg-traslucid-5 dark:hover:bg-l-traslucid-5 transition-all duration-500"
                    onClick={() => onNavigate(1)}>
                    <svg role="img" viewBox="0 0 16 16" className="h-3 fill-white">
            ...
            <div className="flex items-center">
                <button className="mr-1 transition-all duration-300 transform hover:scale-102" onClick={onToggleDarkMode}>
                    {
                        isDark &&
                        <svg viewBox="0 0 457.32 457.32" className="fill-amber-600 h-8 transition-all duration-300 ease-in-out transform rotate-180">
                            <g id="XMLID_467_">
                    ...
                    {
                        !isDark &&
                        <svg viewBox="0 0 24 24" fill="none" className="fill-sky-900 h-8 transition-all duration-300 ease-in-out transform rotate-0">
