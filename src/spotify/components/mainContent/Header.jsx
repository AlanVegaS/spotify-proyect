...
export const Header = () => {
    ...
    const { phoneMode } = useSelector(state => state.spotify);
        ...
        <header className="flex justify-between p-lg">
            <div className="flex items-center">
                ...
                >
                    {
                        phoneMode
                            ? <svg viewBox="0 0 24 24" className="fill-white"><path d="M12.5 3.247a1 1 0 0 0-1 0L4 7.577V20h4.5v-6a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v6H20V7.577l-7.5-4.33zm-2-1.732a3 3 0 0 1 3 0l7.5 4.33a2 2 0 0 1 1 1.732V21a1 1 0 0 1-1 1h-6.5a1 1 0 0 1-1-1v-6h-3v6a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V7.577a2 2 0 0 1 1-1.732l7.5-4.33z"></path></svg>
                            : <svg role="img" viewBox="0 0 16 16" className="h-3 fill-white"><path d="M11.03.47a.75.75 0 0 1 0 1.06L4.56 8l6.47 6.47a.75.75 0 1 1-1.06 1.06L2.44 8 9.97.47a.75.75 0 0 1 1.06 0z"></path></svg>
                    }
                </motion.button>
                ...
                >
                    {
                        phoneMode
                            ? <svg viewBox="0 0 24 24" className="fill-white"><path d="M10.533 1.27893C5.35215 1.27893 1.12598 5.41887 1.12598 10.5579C1.12598 15.697 5.35215 19.8369 10.533 19.8369C12.767 19.8369 14.8235 19.0671 16.4402 17.7794L20.7929 22.132C21.1834 22.5226 21.8166 22.5226 22.2071 22.132C22.5976 21.7415 22.5976 21.1083 22.2071 20.7178L17.8634 16.3741C19.1616 14.7849 19.94 12.7634 19.94 10.5579C19.94 5.41887 15.7138 1.27893 10.533 1.27893ZM3.12598 10.5579C3.12598 6.55226 6.42768 3.27893 10.533 3.27893C14.6383 3.27893 17.94 6.55226 17.94 10.5579C17.94 14.5636 14.6383 17.8369 10.533 17.8369C6.42768 17.8369 3.12598 14.5636 3.12598 10.5579Z"></path></svg>
                            : <svg role="img" viewBox="0 0 16 16" className="h-3 fill-white"><path d="M4.97.47a.75.75 0 0 0 0 1.06L11.44 8l-6.47 6.47a.75.75 0 1 0 1.06 1.06L13.56 8 6.03.47a.75.75 0 0 0-1.06 0z"></path></svg>
                    }

                </motion.button>
                {
                    entity === 'search' ?
                        <form onChange={onSearch} onSubmit={onSubmited} onClick={focusSearch} className="flex items-center ml-sm w-64 xs:w-3/4 bg-l-traslucid-5 dark:bg-traslucid-5 rounded-full h-9 hover:bg-traslucid-5 dark:hover:bg-l-traslucid-5 transition-all duration-500">
                            ...
                            <input ref={inputRef} type="text" className="w-10/12 bg-traslucid-full outline-none" />
                        </form>
                        : <></>
                }
            </div>
